...
#cal_year <- "WL2019_3yr"
#cal_year <- "WL2020_3yr"
#cal_year <- "shallow_below_minus_2019_3yr"
cal_year <- "shallow_below_minus_2020_3yr"
#cal_year <- "shallow_comb_minus_2019_3yr"
#cal_year <- "shallow_comb_minus_2020_3yr"
...
method <- "OK" # OK_Water_Levels, Co_Kriging_GAM, Co_Kriging_Topo_Streams
