...
cal_year <- "Shallow.Below.1929.noJackson" # WL2018, WL2019, WL2010, Shallow.Combined.1929, Shallow.Below.1929, 
...
data <- water_level %>%
  dplyr::select(Longitude, Latitude, SWN, DEM, Depth, ScrTop1, ScrBot1, ScrTop2,
                ScrBot2, SH_Note, Aq2Use,WL2015,WL2018 ,WL2019,WL2020,  
                WL2019Loc.DD.Adjt,WL2020Loc.DD.Adjt, 
                Shallow.Combined.1929.noJackson, Shallow.Below.1929.noJackson)
data$WL2015
