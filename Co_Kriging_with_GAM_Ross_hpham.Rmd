...
# export fig to png
png(filename="output/fitted_variogram.png")
plot(v_WL2020n, pl=T, model=variogram_model_WL2020n_fit, main = "Fitted OK Variogram Model 2020")
dev.off()

# Save to a csv file
write.csv(v_WL2020n,'v_WL2020n.csv')
```
