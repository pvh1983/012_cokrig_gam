...
### load library using the `pacman` package
### pacman will automatically installed missing packages
#if (!require("pacman")) install.packages("pacman")
#pacman::p_load(here,
#rgdal,readr,smerc,maptools,sf,
#raster,rasterVis,
#dismo,spatial,sp,maxstat,RColorBrewer,LaplacesDemon,
#imager,pracma,rgeos)
...
data <- water_level %>%
  dplyr::select(Longitude, Latitude, SWN, DEM, Depth, ScrTop1, ScrBot1, ScrTop2, 
                ScrBot2, SH_Note, Aq2Use, WL2020Loc.DD.Adjt) %>%
...
v_WL2020n <- variogram(WL2020n ~ 1 , data=data_sp2020, cutoff=300000, width=20000)
#str(v_WL2020n)
#summary(v_WL2020n)
#v_WL2020n$np
#v_WL2020n$dist
...
# export fig to png
ofile = paste("output/fitted_variogram_",cal_year,".png")
png(ofile)
plot(v_WL2020n, pl=T, model=variogram_model_WL2020n_fit, main = paste("Fitted OK Variogram Model ", cal_year))
dev.off()

# Save to a csv file
ofile = paste("output/fitted_variogram_",cal_year,".csv")
